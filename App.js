...
import styles from "./styles1.less";
  ...
  render() {
    return (
      <View className={styles.container}>
        ...
        <Text className={styles.welcome2}>Welcome to React Native!</Text>
        <Text className={styles.instructions2}>To get started, edit App.js</Text>
      </View>
    );
  }
}
